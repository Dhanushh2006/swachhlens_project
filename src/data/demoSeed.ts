...
const incidentSpecs: SeedIncident[] = [
  ...
  { id: 'SW-2049', category: 'Overflowing bin', volume: 'Medium', sensitivity: 'MEDIUM', sensitivityReason: 'Residential zone', reports: 3, age: 3.4, status: 'AI_ANALYZED', address: 'Lakeview 2nd Main · Demo City', lat: 12.9689, lng: 77.5918, description: 'Community bin is overflowing into the walking path.' },
  ...
  { id: 'SW-2059', category: 'Construction debris', volume: 'Small', sensitivity: 'LOW', sensitivityReason: 'Residential zone', reports: 2, age: 2.2, status: 'PRIORITIZED', address: 'Jasmine Row · Demo City', lat: 12.9607, lng: 77.5889, description: 'Small brick and tile pile left after repairs.' },
  ...
  { id: 'SW-2067', category: 'Garbage dump', volume: 'Medium', sensitivity: 'LOW', sensitivityReason: 'Residential zone', reports: 2, age: 3, status: 'PRIORITIZED', address: 'Cedar Layout Edge · Demo City', lat: 12.9547, lng: 77.6062, description: 'Mixed bagged garbage repeatedly left on vacant edge.' },
]
...
export function createDemoState(): AppState {
  ...
  return {
    ...
    clusters: [
      { id: 'DC-0183', masterIncidentId: 'SW-2053', memberIncidentIds: ['SW-2053', 'SW-2049', 'SW-2057', 'SW-2061'], similarityScore: 0.91, detectionReason: ['Average proximity 84m', 'Same mixed-waste signature', '12 reports within 72 hours', '9 prototype image matches'], createdAt: isoAgo(14.5) },
