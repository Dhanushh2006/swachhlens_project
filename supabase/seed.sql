...
('30000000-0000-0000-0000-000000002049','SW-2049',12.9689,77.5918,'Lakeview 2nd Main · Demo City',now()-interval '3.4 hours','Community bin overflowing into walking path.','AI_ANALYZED','Overflowing bin','Medium',48,'MEDIUM','MEDIUM','Residential zone',3,'{"volume":12,"locationSensitivity":14,"reportFrequency":10,"complaintAge":5,"hazardContext":0}',true),
...
('30000000-0000-0000-0000-000000002059','SW-2059',12.9607,77.5889,'Jasmine Row · Demo City',now()-interval '2.2 hours','Small brick and tile pile.','PRIORITIZED','Construction debris','Small',30,'LOW','LOW','Residential zone',2,'{"volume":5,"locationSensitivity":6,"reportFrequency":10,"complaintAge":5,"hazardContext":0}',true),
...
('30000000-0000-0000-0000-000000002067','SW-2067',12.9547,77.6062,'Cedar Layout Edge · Demo City',now()-interval '3 hours','Mixed bagged garbage.','PRIORITIZED','Garbage dump','Medium',41,'LOW','LOW','Residential zone',2,'{"volume":12,"locationSensitivity":6,"reportFrequency":10,"complaintAge":5,"hazardContext":0}',true)
...
('60000000-0000-0000-0000-000000000001','30000000-0000-0000-0000-000000002057',.88),
('60000000-0000-0000-0000-000000000001','30000000-0000-0000-0000-000000002061',.84)
on conflict do nothing;
